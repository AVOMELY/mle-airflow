...
def create_table(**kwargs):
    ...
    from sqlalchemy import MetaData, Table, Column, String, Integer, inspect, Float, UniqueConstraint, DateTime
    ti = kwargs['ti']
    data = ti.xcom_push(key='created_table', value='create_table') # выгрузка данных из task_instance
    ...
    ti.xcom_push('created_table', data)
...
def extract(**kwargs):
    ...
    """
    ti = kwargs['ti']
    data = ti.xcom_push(key='extracted_data', value='extract') # выгрузка данных из task_instance
